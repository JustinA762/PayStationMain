...
public class PayStationImplTest {
    ...
    PayStation linear = new Linear1RateStrategy();
    @After
    ...
    {
        int amountAdded = 25;
        ps.addPayment(amountAdded, linear);
        ps.buy();
        ps.addPayment(amountAdded, linear);
        ps.cancel();
