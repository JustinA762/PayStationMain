...
public class PayStationImpl implements PayStation {
    ...
    @Override
    public void addPayment(int coinValue, PayStation rateStrategy)
         ...
         */
        PayStation ps = rateStrategy;

        coinMap.put(coinValue, coinMap.getOrDefault(coinValue, 0) + 1);
        insertedSoFar += coinValue;

        timeBought = ps.calculateTime(insertedSoFar);
    }
    ...
    @Override
    public int calculateTimeForCal(int amount, Calendar cal) {
        return 0;
    }
}
